            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="{{route('main.create')}}" class="signup-image-link">Create an account</a>
                    </div> 

                    <div class="signin-form">
                        <h2 class="form-title">Sign in</h2>
                        <form method="POST" class="register-form" id="login-form" action="{{action('MainController@checkUser')}}">
                            {{csrf_field()}}
